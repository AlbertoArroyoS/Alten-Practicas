...
export class ListSoldComponent {
  ...
  recargarTablaLibros(): void {
    this.loadClientSolds(this.currentPage, this.pageSize);
  }

  // Método para cambiar la página de la tabla
  changePage(pageNumber: number): void {
    this.loadClientSolds(pageNumber, this.pageSize);
  }
