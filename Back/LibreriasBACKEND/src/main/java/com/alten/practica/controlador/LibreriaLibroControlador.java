...
public class LibreriaLibroControlador {
     ...
     *
     * Este método se utiliza para recuperar todos los libros de librería almacenados en la base de datos.
     * Devuelve un {@link ResponseEntity} que contiene una lista de DTO de libros de librería y el estado HTTP
     * adecuado que representa el resultado de la operación (normalmente {@link HttpStatus#OK} si la operación es exitosa).
     *
     * @return un {@link ResponseEntity} que contiene una lista de DTO de libros de librería y el estado HTTP
     ...
     *
     * Este método se utiliza para recuperar un libro de librería específico de la base de datos utilizando su ID.
     * Devuelve un {@link ResponseEntity} que contiene un DTO del libro de librería encontrado y el estado HTTP
     * adecuado que representa el resultado de la operación (normalmente {@link HttpStatus#OK} si la operación es exitosa).
     *
     * @param id el ID del libro de librería a buscar.
     * @return un {@link ResponseEntity} que contiene un DTO del libro de librería encontrado y el estado HTTP
     *         adecuado que representa el resultado de la operación.
     */
     ...
     *
     * Este método se utiliza para crear un nuevo libro de librería en la base de datos utilizando los datos proporcionados
     * en el DTO del libro de librería.
     * Después de la creación exitosa, devuelve un {@link ResponseEntity} que contiene un {@link HrefEntityDTO}
     * con detalles del libro de librería creado, la URL del recurso y el estado HTTP adecuado para representar
     ...
     * @return un {@link ResponseEntity} que contiene un {@link HrefEntityDTO} con detalles del libro de librería creado,
     ...
     *
     * Este método se utiliza para actualizar la información de un libro de librería existente en la base de datos.
     * Para ello, se proporciona un DTO del libro de librería con la información actualizada, así como el ID del libro de librería
     ...
     * con detalles del libro de librería actualizado, la URL del recurso y el estado HTTP adecuado para representar
     ...
     * @return un {@link ResponseEntity} que contiene un {@link HrefEntityDTO} con detalles del libro de librería actualizado,
     *         la URL del recurso y el estado HTTP adecuado que representa el resultado de la operación.
     */
     ...
     *
     * Este método se utiliza para eliminar un libro de librería específico de la base de datos utilizando su ID.
     * Devuelve un {@link ResponseEntity} que contiene un {@link HrefEntityDTO} con detalles del libro de librería eliminado,
     ...
     * @return un {@link ResponseEntity} que contiene un {@link HrefEntityDTO} con detalles del libro de librería eliminado,
     *         la URL del recurso y el estado HTTP adecuado que representa el resultado de la operación.
     */
